...
A 48-hour Binance-testnet paper run produced a live Sharpe of ${\approx}1.3$%
\footnote{Annualised from 48\,h of data; the standard error on this estimate
  is ${\approx}0.4$, so the point value should not be over-interpreted.},
...
Metric & Value \\
\midrule
Annualised Sharpe (48-h est.) & $\approx 1.3$ \\
PnL & +\$1\,240 (+1.24\,\%) \\
Max drawdown & 2.1\,\% \\
...
The paper Sharpe (${\approx}1.3$) is 30\,\% below the backtest (1.87) over the same
48-hour window.
Attribution:
\begin{itemize}
